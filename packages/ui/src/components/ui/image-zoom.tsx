  ...
  >
    <Zoom
      classDialog={cn(
        ...
        // `!` overrides react-medium-image-zoom's default white overlay so the
        // backdrop stays dark + blurred (matching the lightbox) instead of
        // flashing solid white when zoomed.
        '[&_[data-rmiz-modal-overlay="hidden"]]:!bg-transparent',
        '[&_[data-rmiz-modal-overlay="visible"]]:!bg-background/90 [&_[data-rmiz-modal-overlay="visible"]]:backdrop-blur-md',
